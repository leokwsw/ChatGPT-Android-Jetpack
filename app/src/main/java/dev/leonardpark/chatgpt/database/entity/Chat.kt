package dev.leonardpark.chatgpt.database.entity

import androidx.annotation.Keep
import androidx.room.*
import dev.leonardpark.chatgpt.di.GsonSkip
...
data class ChatMessage(
    ...
    val parsedRole get() = if (fromUser)
        dev.leonardpark.chatgpt.R.string.you
    else
        dev.leonardpark.chatgpt.R.string.chatgpt
}
